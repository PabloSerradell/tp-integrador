    ...
    public void create(ServicioTuristico servicioTuristico) {
        ...
        try {
            ...
            for (PaqueteTuristico listaPaquetesPaqueteTuristicoToAttach : servicioTuristico.getListaPaquetes()) {
                listaPaquetesPaqueteTuristicoToAttach = em.getReference(listaPaquetesPaqueteTuristicoToAttach.getClass(), listaPaquetesPaqueteTuristicoToAttach.getCodigo_paquete());
    ...
    public void edit(ServicioTuristico servicioTuristico) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            for (PaqueteTuristico listaPaquetesNewPaqueteTuristicoToAttach : listaPaquetesNew) {
                listaPaquetesNewPaqueteTuristicoToAttach = em.getReference(listaPaquetesNewPaqueteTuristicoToAttach.getClass(), listaPaquetesNewPaqueteTuristicoToAttach.getCodigo_paquete());
