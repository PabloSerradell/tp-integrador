			...
			<section class="banner-area relative">
				...
				<div class="container">
					<div class="row fullscreen align-items-center justify-content-between">
                                            ...
                                            <p class="text-white">
						El trabajo en equipo marca la diferencia. Debemos nuestro éxito a la pasión y al compromiso de nuestros empleados.
                                            </p>
							...
							<ul class="nav nav-tabs" id="myTab" role="tablist">
							  ...
							  <li class="nav-item">
                                                            <a class="nav-link" id="hotel-tab" href="crearUsuario.jsp" >Crear empleado</a>
							  </li>
							</ul>
                                            </div>
                                            
                                            <!-- ACÁ EMPIEZA LA TABLA DE EMPLEADOS -->
                                            ...
                                            <table class="table table-dark table-striped">
                                              ...
                                              <tbody>
                                                ...
                                                <tr>
                                                  ...
                                                  <% long id_usuario = usua.getId_usuario(); %>
                                            ...
                                            <!-- ACÁ TERMINA LA TABLA DE EMPLEADOS -->
